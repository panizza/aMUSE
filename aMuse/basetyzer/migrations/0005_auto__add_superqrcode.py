...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuperQRCode'
        db.create_table(u'basetyzer_superqrcode', (
        ...
        db.send_create_signal(u'basetyzer', ['SuperQRCode'])


    def backwards(self, orm):
        # Deleting model 'SuperQRCode'
        db.delete_table(u'basetyzer_superqrcode')
