...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'basetyzer_experience', 'hash_url', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Adding field 'Exhibit.scan_limit'
        db.add_column(u'basetyzer_exhibit', 'scan_limit',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Exhibit.scan_limit'
        db.delete_column(u'basetyzer_exhibit', 'scan_limit')
    ...
    models = {
        ...
        u'basetyzer.action': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basetyzer.Comment']", 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basetyzer.Photo']", 'null': 'True', 'blank': 'True'}),
            'scan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basetyzer.Scan']", 'null': 'True', 'blank': 'True'})
        },
        u'basetyzer.comment': {
        ...
        u'basetyzer.exhibit': {
            ...
            'scan_limit': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        u'basetyzer.experience': {
            'Meta': {'ordering': "['date']", 'object_name': 'Experience'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'hash_url': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
