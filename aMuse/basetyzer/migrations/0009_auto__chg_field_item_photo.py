...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.photo'
        db.alter_column(u'basetyzer_item', 'photo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Item.photo'
        db.alter_column(u'basetyzer_item', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
