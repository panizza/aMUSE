...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experience.date'
        db.alter_column(u'basetyzer_experience', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Experience.date'
        db.alter_column(u'basetyzer_experience', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'basetyzer.experience': {
            ...
            'hash_url': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '40'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
