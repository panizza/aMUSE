...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.nfc_tag'
        db.delete_column(u'basetyzer_item', 'nfc_tag_id')

        # Adding field 'Item.tag'
        db.add_column(u'basetyzer_item', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['basetyzer.Tag']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Item.nfc_tag'
        db.add_column(u'basetyzer_item', 'nfc_tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['basetyzer.NFC']),
                      keep_default=False)

        # Deleting field 'Item.tag'
        db.delete_column(u'basetyzer_item', 'tag_id')
    ...
    models = {
        ...
        u'basetyzer.item': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basetyzer.Tag']"}),
